...
def update_notebook():
    ...
    # Find the cell with product sales analysis and update it
    for cell in nb['cells']:
        if cell['cell_type'] == 'code' and 'product_sales = df_clean.groupby' in cell['source']:
            cell['source'] = '''# Calculate total amount for each transaction
